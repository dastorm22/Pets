                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    <label for="inputExperience" class="col-sm-2 control-label">Biografia</label>
                                ...
                                <div class="form-group">
                                    <label for="photo" class="col-sm-2 control-label"> Cambiar foto de perfil</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label">Cambiar Contraseña</label>
